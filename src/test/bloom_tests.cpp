...
BOOST_AUTO_TEST_CASE(bloom_create_insert_key, *boost::unit_test::disabled() *boost::unit_test::description("requires real secret"))
{
    string strSecret = string("FN5Wo4ZNbQLRtxU3PoKfgbmYDUSP2Yhq6Bug1Lw3FosQgWypJu9s");
...
BOOST_AUTO_TEST_CASE(bloom_match, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
...
BOOST_AUTO_TEST_CASE(merkle_block_1, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
    // Random real block (0000000000013b8ab2cd513b0261a14096412195a72a0c4827d229dcc7e0f7af)
    // With 9 txes
    CBlock block;
    CDataStream stream(ParseHex(""), SER_NETWORK, PROTOCOL_VERSION);
    stream >> block;

    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    // Match the last transaction
    filter.insert(uint256("0xa684de047a6498fe468f6a9c68c7bbd34086123a9458c20fdc04ae3151a81717"));
...
BOOST_AUTO_TEST_CASE(merkle_block_2, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
...
BOOST_AUTO_TEST_CASE(merkle_block_2_with_update_none, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
    // Random real block (000000005a4ded781e667e06ceefafb71410b511fe0d5adc3e5a27ecbec34ae6)
    // With 4 txes
    CBlock block;
...
BOOST_AUTO_TEST_CASE(merkle_block_3_and_serialize, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
...
BOOST_AUTO_TEST_CASE(merkle_block_4, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
...
BOOST_AUTO_TEST_CASE(merkle_block_4_test_p2pubkey_only, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
    // Random real block (000000000000b731f2eef9e8c63173adfb07e41bd53eb0ef0a6b720d6cb6dea4)
    // With 7 txes
    CBlock block;
...
BOOST_AUTO_TEST_CASE(merkle_block_4_test_update_none, *boost::unit_test::disabled() *boost::unit_test::description("requires real block"))
{
    // Random real block (000000000000b731f2eef9e8c63173adfb07e41bd53eb0ef0a6b720d6cb6dea4)
    // With 7 txes
    CBlock block;
