    ...
    filter(0)
{
    ...
    if(GetBoolArg("-chart", true))
    {
        ...
        ui->hashplot->xAxis->setNumberFormat("f");
        ui->hashplot->xAxis->setNumberPrecision(0);
        ui->hashplot->xAxis->setTickLabelRotation(15);
        ui->hashplot->xAxis->setAutoSubTicks(false);
        ui->hashplot->xAxis->setSubTickCount(4);
        ui->hashplot->yAxis->setLabel(tr("PrimesPS"));
